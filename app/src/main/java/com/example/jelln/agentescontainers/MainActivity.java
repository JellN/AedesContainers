...
import com.example.jelln.agentescontainers.fragments.ChatsFragment;
import com.example.jelln.agentescontainers.fragments.ContFragment;
import com.example.jelln.agentescontainers.fragments.MapsFragment;
import com.example.jelln.agentescontainers.fragments.ProfileFragment;
import com.example.jelln.agentescontainers.fragments.UsersFragment;
...
public class MainActivity extends AppCompatActivity {
   ...
   //     eventoclick();
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(u.getImageUrl() == null){
                    profilie_image.setImageResource(R.drawable.fuke);
                }else{
      ...
      final   TabLayout tabLayout = findViewById(R.id.tab_layout);
        ...
        viewPageAdapter.addFragment(new MapsFragment(), "Mapa");
        viewPageAdapter.addFragment(new ContFragment(), "Containers");
        viewPageAdapter.addFragment(new UsersFragment(), "Agentes");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(unread == 0){
                    tabLayout.getTabAt(2).setText("Agentes");

                }else{
                    tabLayout.getTabAt(2).setText("("+unread+") Agentes");
                }
    ...
    private void deslogars2() {
        Toast.makeText(getApplicationContext(), "Esta conta não é de um Usuário", Toast.LENGTH_LONG);
        Conexao.logOut();
        Intent i = new  Intent(getApplicationContext(), login.class);
        i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
