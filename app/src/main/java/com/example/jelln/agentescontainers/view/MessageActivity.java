...
import com.example.jelln.agentescontainers.Adapter.MessageAdapter;
import com.example.jelln.agentescontainers.MainActivity;
import com.example.jelln.agentescontainers.Notifications.Client;
import com.example.jelln.agentescontainers.Notifications.Data;
...
import com.example.jelln.agentescontainers.fragments.APIService;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    Data data = new Data(user.getUid(), R.drawable.icone, username+": "+message, "Nova mensagem",
                            userid);
